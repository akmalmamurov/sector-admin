...
export const EDITOR_JS_NEWS: Record<string, ToolConstructable | ToolSettings> =
  {
    paragraph: {
            ...
            return new Promise((resolve, reject) => {
              ...
              reader.onload = () => {
                const images = JSON.parse(
                  localStorage.getItem("newsfullDescriptionImages") || "[]"
                );
                images.push({ name: file.name, base64: reader.result });
                localStorage.setItem("newsfullDescriptionImages", JSON.stringify(images));
