...
import { Home,ShoppingBasket, Grid, LogOut, User2,  Earth, ListFilter, Image, MessageCircle, Shield, Percent, TrendingUp, Newspaper, ListOrdered } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Remark", url: "/remark", icon: MessageCircle },
